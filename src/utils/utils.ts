...
/**
 * Функция для красивого представления цены
 * @param price цена, которую мы преобразуем
 * @returns строка с ценой и единицей измерения
 */
export function priceWithUnit(price: Price): string {
	if (price === null) {
		return 'Бесценно';
	}
...
/**
 * Задает элементу категорию со стилем
 * @param element HTML элемент
 * @param category категория
 */
export function setCategory(element: HTMLElement, category: string) {
